...
public class TwoPieceAuto extends SequentialCommandGroup {
  ...
  public TwoPieceAuto(Drive drive, Arm arm) {
    ...
    addCommands(new SetArmExtensionPosition(arm, 20),
                new SetArmExtensionPosition(arm, 1),
                new ParallelCommandGroup(new SetArmRotationPosition(arm, 180), new AutonomousFollower(drive, pathJSON)),
                new ParallelCommandGroup(new SetArmRotationPosition(arm, 45), new AutonomousFollower(drive, pathJSON2)),
                new SetArmExtensionPosition(arm, 20),
                new SetArmExtensionPosition(arm, 1),
                new ParallelCommandGroup(new SetArmRotationPosition(arm, 180), new AutonomousFollower(drive, pathJSON3)),
                new ParallelCommandGroup(new SetArmRotationPosition(arm, 90), new AutonomousFollower(drive, pathJSON4))
                // new SetArmExtensionPosition(arm, 20),
                // new SetArmExtensionPosition(arm, 1)
    );
  }
