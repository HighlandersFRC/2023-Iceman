...
public class ThreePieceBumpAuto extends SequentialCommandGroup {
  /** Creates a new ThreePieceBumpAuto. */
  ...
  public ThreePieceBumpAuto(Drive drive, ArmExtension armExtension, ArmRotation armRotation, Wrist wrist, FlipChecker flipChecker, Peripherals peripherals, Lights lights, Intake intake) {
    ...
    try {
        pathingFile3 = new File("/home/lvuser/deploy/2PieceBumpPart3.json");
    ...
    try {
        pathingFile4 = new File("/home/lvuser/deploy/3PieceBumpPart4.json");
    ...
    addCommands(
      new ParallelCommandGroup(
        ...
        new RotateWrist(wrist, flipChecker, Constants.MID_PLACEMENT_BACKSIDE_WRIST_ROTATION - 2),
      ...
      new ParallelDeadlineGroup(
        new MoveToPieceForwards(drive, peripherals, lights, intake, 0.7),
        new RunIntake(intake, -55, 1),
        new SetArmRotationPosition(armRotation, flipChecker, Constants.CUBE_FRONTSIDE_ARM_ROTATION),
      ...
      new ParallelDeadlineGroup(
        ...
        new ParallelCommandGroup(
          ...
          new SequentialCommandGroup(
            ...
            new WaitCommand(1.2),
            new SetArmRotationPosition(armRotation, flipChecker, Constants.HIGH_PLACEMENT_BACKSIDE_ARM_ROTATION + 2)
          ),
          new SequentialCommandGroup(
            new WaitCommand(2.4),
            new SetArmExtensionPosition(lights, armExtension, armRotation, Constants.MID_PLACEMENT_ARM_EXTENSION)
