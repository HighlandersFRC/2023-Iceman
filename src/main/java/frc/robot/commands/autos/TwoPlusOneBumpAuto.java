...
public class TwoPlusOneBumpAuto extends SequentialCommandGroup {
  ...
  public TwoPlusOneBumpAuto(Drive drive, ArmExtension armExtension, ArmRotation armRotation, Wrist wrist, FlipChecker flipChecker, Peripherals peripherals, Lights lights, Intake intake) {
