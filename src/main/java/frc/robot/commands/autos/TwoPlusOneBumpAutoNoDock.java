...
public class TwoPlusOneBumpAutoNoDock extends SequentialCommandGroup {
  ...
  public TwoPlusOneBumpAutoNoDock(Drive drive, ArmExtension armExtension, ArmRotation armRotation, Wrist wrist, FlipChecker flipChecker, Peripherals peripherals, Lights lights, Intake intake) {
    ...
    try {
        pathingFile3 = new File("/home/lvuser/deploy/2PieceBumpPart2.json");
